...
void turnDrive(double pct, double rev, bool wait) {
  rF.startRotateFor(rev - .5, vex::rotationUnits::rev, pct, vex::velocityUnits::pct);
  lB.startRotateFor(rev, vex::rotationUnits::rev, pct, vex::velocityUnits::pct);
  lF.startRotateFor(rev, vex::rotationUnits::rev, pct, vex::velocityUnits::pct);
  if (wait) {
      rB.rotateFor(rev - .5, vex::rotationUnits::rev, pct, vex::velocityUnits::pct);
      return;
  }
  rB.startRotateFor(rev - .5, vex::rotationUnits::rev, pct, vex::velocityUnits::pct);
}
